...
<Layout>
    <div slot="subheader">
        <div class="my-6 lg:my-12 container px-6 mx-auto flex flex-col lg:flex-row items-start lg:items-center justify-between pb-4 border-b border-gray-300">
            <div>
                <h4 class="text-2xl font-bold leading-tight text-gray-800">Welcome</h4>
            ...
            <div class="mt-6 lg:mt-0">
                ...
                <button class="transition duration-150 ease-in-out hover:bg-indigo-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 border bg-indigo-700 rounded text-white px-8 py-2 text-sm">Tambah Event</button>
            </div>
        </div>

    </div>
 <div slot="content">
    You are logged in as: {JSON.stringify($page.props.user)}
 </div>
</Layout>