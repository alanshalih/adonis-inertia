...
import { page } from '@inertiajs/inertia-svelte'
        ...
        sideBar.style.transform = "translateX(-100%)"; 
            ...
            let single = document.querySelector("#dropdownmenu"); 
            ...
            if (check) {
              ...
              <div class="h-full w-full absolute">
                  ...
                  <div id="mobile-nav" class="w-full xl:hidden h-full absolute z-40">
                      <div class="bg-gray-800 opacity-50 inset-0 fixed w-full h-full" on:click="{()=>{sidebarHandler(false)}}"></div>
                          ...
                          <div class="flex flex-col justify-between h-full">
                              <div class="px-6 pt-4 overflow-y-auto">
                                  <div class="flex items-center justify-between">
                                      <div aria-label="Home"  class="flex items-center">
                                      ...
                                      <button id="cross" class="hidden text-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 rounded" on:click="{()=>{sidebarHandler(false)}}">
                                      ...
                                      <li class="text-gray-700 pt-8">
                                          <div class="flex items-center">
                                              <div class="flex items-center">
                                                  ...
                                                  <a href="/" class="text-gray-700 ml-3 text-lg">Products</a>
                                              </div>
                                              <button id="chevronup" on:click="{()=>{listHandler(true)}}" class="ml-4 focus:outline-none focus:ring-2 focus:ring-gray-500 rounded">
                                                  <img src="https://tuk-cdn.s3.amazonaws.com/can-uploader/light_with_Grey_background-svg4.svg" alt="up">
                                              </button>
                                              <button id="chevrondown" on:click="{()=>{listHandler(false)}}" class="hidden ml-4 focus:outline-none focus:ring-2 focus:ring-gray-500 rounded ">
                                          ...
                                          <div id="list" class="hidden">
                                              <ul class="my-3">
                                                  <li class="text-sm text-indigo-500 py-2 px-6"><a href="/"> Best Sellers </a></li>
                                                  <li class="text-sm text-gray-800 hover:text-indigo-500 py-2 px-6"><a href="/"> Out of Stock</a></li>
                                                  <li class="text-sm text-gray-800 hover:text-indigo-500 py-2 px-6"><a href="/"> New Products</a></li>
                                              </ul>
                                          </div>
                                      </li>
                                      ...
                                      <li class="text-gray-800 pt-8">
                                          <div class="flex items-center">
                                              <div class="flex items-center">
                                                  ...
                                                  <a href="/" class="text-gray-800 ml-3 text-lg">Deliverables</a>
                                              </div>
                                              <div>
                                                  <button id="chevronup2" on:click="{()=>{listHandler2(true)}}" class="ml-4 focus:outline-none focus:ring-2 focus:ring-gray-500 rounded">
                                                      <img src="https://tuk-cdn.s3.amazonaws.com/can-uploader/light_with_Grey_background-svg4.svg" alt="up">
                                                  </button>
                                                  <button id="chevrondown2" on:click="{()=>{listHandler2(false)}}" class="hidden ml-4 focus:outline-none focus:ring-2 focus:ring-gray-500 rounded">
                                                      <img class="transform rotate-180" src="https://tuk-cdn.s3.amazonaws.com/can-uploader/light_with_Grey_background-svg4.svg" alt="down">
                                                  </button>
                                              </div>
                                          </div>
                              ...
                              <div class="w-full">
                                  ...
                                  <div class="border-t border-gray-300">
                                      <div class="w-full flex items-center justify-between px-6 pt-1">
                                          <div class="flex items-center">
                                              <img alt="display avatar"  src="{$page.props.user.gravatar}" class="w-8 h-8 rounded-md" />
                                              <p class="text-gray-800 text-base leading-4 ml-2">{$page.props.user.name}</p>
                                          </div>
                                          <ul class="flex">
                      ...
                      <div class="container px-6 justify-between h-16 flex items-center lg:items-stretch mx-auto">
                          <div class="h-full flex items-center">
                              ...
                              <ul class="pr-12 xl:flex items-center h-full hidden">
                                  ...
                                  <li class="hover:text-indigo-700 cursor-pointer h-full flex items-center text-sm text-gry-800 mx-10 tracking-normal" ><a href="/">Products</a></li>
                                  <li class="hover:text-indigo-700 cursor-pointer h-full flex items-center text-sm text-gry-800 mr-10 tracking-normal"><a href="/">Performance</a></li>
                                  <li class="hover:text-indigo-700 cursor-pointer h-full flex items-center text-sm text-gray-800 tracking-normal"><a href="/">Deliverables</a></li>
                              </ul>
                          </div>
                              ...
                              <div class="w-full h-full flex items-center">
                                  ...
                                  <div class="w-full h-full flex">
                                      ...
                                      <div aria-haspopup="true" class="cursor-pointer w-full flex items-center justify-end relative"  >
                                          <button aria-haspopup="true" on:click="{dropdownHandler}" class="focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 rounded flex items-center" >
                                              <img class="rounded-full h-10 w-10 object-cover" src="{$page.props.user.gravatar}" alt="avatar" />
                                              <p class="text-gray-800 text-sm ml-2">{$page.props.user.name}</p>
                                          </button>
                                          <ul id="dropdownmenu" class="p-2 w-40 border-r bg-white absolute rounded z-40 left-0 shadow mt-64 hidden ">
                          ...
                          <div class="visible xl:hidden flex items-center">
                              <div>
                                  <button id="menu" class="text-gray-800 rounded focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800" on:click="{()=>{sidebarHandler(true)}}">
